...
### Correct stale-manifest recovery documentation ([#750](https://github.com/Basekick-Labs/arc/issues/750))

Correct documentation that claimed compaction manifests older than seven
days were automatically deleted. Age only triggers a warning; recovery
still validates the output and follows its normal cleanup and retry rules.
