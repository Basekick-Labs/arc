...
### Delete API WHERE validation ignores SQL tokens inside string literals ([#834](https://github.com/Basekick-Labs/arc/issues/834))

Delete API WHERE validation no longer rejects forbidden SQL keywords or punctuation when they occur only inside string literals. Contributed by @hizlidepoo.
