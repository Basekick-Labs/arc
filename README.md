...
- [@Thundercloud12](https://github.com/Thundercloud12) (Keerthan Poojary) — Azure not-found error detection via errors.As, covering joined multi-errors (#670); PREPARE/EXECUTE blocked by the read-SQL validator as defense-in-depth (#767)
