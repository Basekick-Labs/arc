...
// Mode is the router's operating mode, from the ARCX_ROUTER env (parsed once at
...
// ParseMode maps the ARCX_ROUTER env value to a Mode. Unknown/empty → shadow (the
